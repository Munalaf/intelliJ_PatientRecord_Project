...
public class PatientRecordResults {
    ...
    public PatientRecordResults(String name, int age, String address, String contactNumber, String diagnosis, int weight, int height, String bloodType, String mediciations, List<String> latestDiagnosis, String id, List<List<String>> record, List<String> listOfSurgereies, String currentHospital) {
        this.name = name;
        this.age = age;
